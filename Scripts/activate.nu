...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Projetos\WorkspaceGit\Python\python-developer\sistema-bancario-desafio'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Projetos\WorkspaceGit\Python\python-developer\sistema-bancario-desafio\Scripts\deactivate.nu'
